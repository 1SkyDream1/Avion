    ...
    (() => {
        ...
        let bodyLock = (delay = 500) => {
            ...
            if (bodyLockStatus) {
                let lock_padding = document.querySelectorAll("[data-lp]");
                for (let index = 0; index < lock_padding.length; index++) {
                    console.log(lock_padding[index]);
                    const el = lock_padding[index];
        ...
        function menuInit() {
            if (document.querySelector(".icon-menu")) document.addEventListener("click", (function(e) {
                if (bodyLockStatus && e.target.closest(".icon-menu")) {
                    ...
                    if (promocode && !promocode.classList.contains("_promocode-none")) promocode.classList.toggle("_promocode-close");
                }
            }));
        }
        ...
        const promocode = document.querySelector(".promocode");
        if (promocode) {
            const closePromocode = document.querySelector(".promocode__close");
            closePromocode.addEventListener("click", (function(e) {
                promocode.classList.add("_promocode-close");
                promocode.classList.add("_promocode-none");
            }));
        }
        window["FLS"] = true;
        isWebp();
